...
public class CommonFeedback1{
	private int userId;
	private String feedbackSubject;
	private String feedbackMessage;
	private int productId;
	
	public CommonFeedback1() {
		super();
	}
	public CommonFeedback1(int userId, String feedbackSubject, String feedbackMessage, int productId) {
		super();
		this.userId = userId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CommonFeedback1 other = (CommonFeedback1) obj;
